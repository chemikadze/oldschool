...
begin
  ...
  Image1.Canvas.MoveTo(Round((Image1.Width-20)/8 * 0 +10), Image1.Height - Round((Image1.Height-20)/8 * 2 ) - 10);
  Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 8 +10), Image1.Height - Round((Image1.Height-20)/8 * 2 ) - 10);
  Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 2 +10), Image1.Height - Round((Image1.Height-20)/8 * 7 ) - 10);
  Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 0 +10), Image1.Height - Round((Image1.Height-20)/8 * 2 ) - 10);

  Image1.Canvas.MoveTo(Round((Image1.Width-20)/8 * 1 +10), Image1.Height - Round((Image1.Height-20)/8 * 3 ) - 10);
  Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 5 +10), Image1.Height - Round((Image1.Height-20)/8 * 3 ) - 10);
  Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 5 +10), Image1.Height - Round((Image1.Height-20)/8 * 4 ) - 10);
  Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 1 +10), Image1.Height - Round((Image1.Height-20)/8 * 4 ) - 10);
  Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 1 +10), Image1.Height - Round((Image1.Height-20)/8 * 3 ) - 10);

  Image1.Canvas.FloodFill(Round((Image1.Width-20)/8 * 6 +10), Image1.Height - Round((Image1.Height-20)/8 * 3) - 10,
                          clRed, fsBorder);
  ...
  if (
    (x>=0) and (x<=8) and
    (y>=2) and (2+2.5*x >= y) and (5*(2-x)/6+7 >= y)
    and not ((x>1) and (x<5) and (y>3) and (y<4)) 
  )
  then
