...
begin
  ...
  begin
    for j:=1 to length(Memo1.Lines[i]) do
     if (
      (Memo1.Lines[i][j] = 'а') or
      (Memo1.Lines[i][j] = 'е') or
      (Memo1.Lines[i][j] = 'ё') or
      (Memo1.Lines[i][j] = 'и') or
      (Memo1.Lines[i][j] = 'о') or
      (Memo1.Lines[i][j] = 'у') or
      (Memo1.Lines[i][j] = 'ы') or
      (Memo1.Lines[i][j] = 'э') or
      (Memo1.Lines[i][j] = 'ю') or
      (Memo1.Lines[i][j] = 'я')
     )then
      inc(c);
  end;
  Label2.Caption := 'Гласных: ' + IntToStr(c);
end;
