...
begin
  ...
  // cx = Round((Image1.Width-20)/8 * x+10);
  // cy = Image1.Height - Round((Image1.Height-20)/8 * y) - 10;
  
  Image1.Canvas.Pen.Color := clAqua;
  Image1.Canvas.Brush.Color := clAqua;

  Image1.Canvas.MoveTo(Round((Image1.Width-20)/8 * 0 +10), Image1.Height - Round((Image1.Height-20)/8 * 4 ) - 10);
  Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 8 +10), Image1.Height - Round((Image1.Height-20)/8 * 4 ) - 10);
  Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 8 +10), Image1.Height - Round((Image1.Height-20)/8 * 8 ) - 10);
  Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 0 +10), Image1.Height - Round((Image1.Height-20)/8 * 4 ) - 10);

  Image1.Canvas.MoveTo(Round((Image1.Width-20)/8 * 5 +10), Image1.Height - Round((Image1.Height-20)/8 * 5 ) - 10);
  Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 7 +10), Image1.Height - Round((Image1.Height-20)/8 * 5 ) - 10);
  Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 7 +10), Image1.Height - Round((Image1.Height-20)/8 * 6 ) - 10);
  Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 5 +10), Image1.Height - Round((Image1.Height-20)/8 * 6 ) - 10);
  Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 5 +10), Image1.Height - Round((Image1.Height-20)/8 * 5 ) - 10);

  Image1.Canvas.FloodFill(Round((Image1.Width-20)/8 * 4 +10), Image1.Height - Round((Image1.Height-20)/8 * 5 ) - 10,
                          clWhite, fsSurface);
  ...
  if (
    (x>=0) and (x<=8) and
    (y>=4) and (y<=4+x/2) and
    not ((x>5) and (x<7) and (y>5) and (y<6))
  )
  then
