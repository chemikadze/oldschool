...
Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 6 +10), Image1.Height - Round((Image1.Height-20)/8 * 6 ) - 10);
Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 4 +10), Image1.Height - Round((Image1.Height-20)/8 * 6 ) - 10);
Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 4 +10), Image1.Height - Round((Image1.Height-20)/8 * 2 ) - 10);
...
Image1.Canvas.FloodFill(Round((Image1.Width-20)/8 * 1 +10), Image1.Height - Round((Image1.Height-20)/8 * 1 ) - 10, clGreen, fsBorder);
  ...
  if ((y>=0) and (y<=2) and (x>=0) and (x<=8)) or
     ((y>=2) and (y<=4) and (x>=4) and (x<=6)) or
     ((y>=4) and (y<=6) and (x>=4) and (x<=8)) or
     ((y>=6) and (y<=8) and (x>=6) and (x<=8)) 
  then
