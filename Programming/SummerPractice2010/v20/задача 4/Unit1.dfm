object Form1: TForm1
    ...
    Columns = <
      ...
      item
        ...
        PickList.Strings = (
          ...
          '4'
          '5')
        Title.Caption = #1054#1094#1077#1085#1082#1072' '#1072#1090#1090#1077#1089#1090#1072#1090#1072
        Visible = True
      end>
  end
  ...
  object BFind: TButton
    ...
    Width = 209
    Height = 25
    Caption = #1044#1077#1074#1091#1096#1082#1080'-'#1086#1090#1083#1080#1095#1085#1080#1094#1099
    TabOrder = 3
    OnClick = BFindClick
  end
  object TStud: TTable
