...
begin
  ...
  Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 3 +10), Image1.Height - Round((Image1.Height-20)/8 * 0 ) - 10);
  Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 3 +10), Image1.Height - Round((Image1.Height-20)/8 * 1 ) - 10);
  Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 4 +10), Image1.Height - Round((Image1.Height-20)/8 * 1 ) - 10);
  ...
  Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 6 +10), Image1.Height - Round((Image1.Height-20)/8 * 5 ) - 10);
  Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 4 +10), Image1.Height - Round((Image1.Height-20)/8 * 5 ) - 10);
  ...
  if ((y>=0) and (y<=5.0/4.0*x) and (x>=0) and (x<=4)) and
    not ((x>3)and(y<1))
    or ((x>=4) and (x<=6) and (y>=4) and (y<=5))
  then
