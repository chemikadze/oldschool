object Form1: TForm1
  ...
  object BFind: TButton
    ...
    Width = 425
    Height = 25
    Caption = #1042#1099#1074#1077#1089#1090#1080' '#1093#1086#1088#1086#1096#1080#1089#1090#1086#1074' '#1089#1086' '#1089#1090#1080#1087#1077#1085#1076#1080#1077#1081
    TabOrder = 3
    OnClick = BFindClick
  end
  object TStud: TTable
