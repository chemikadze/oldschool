...
Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 2 +10), Image1.Height - Round((Image1.Height-20)/8 * 4 ) - 10);
...
Image1.Canvas.LineTo(Round((Image1.Width-20)/8 * 0 +10), Image1.Height - Round((Image1.Height-20)/8 * 0 ) - 10);
  ...
  if (
    ((x>=0) and (x<=8) and (y>=0) and (y<=2))or
    ((x>=2) and (x<=6) and (y>=2) and (y<=4))or
    ((x>=4) and (x<=8) and (y>=4) and (y<=6))or
    ((x>=6) and (x<=8) and (y>=6) and (y<=8))
  )
  then
