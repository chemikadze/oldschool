...
<form method="POST" action="{#SITE_ROOT#}/addarticle.php{if isset($subject)}?subject={$subject}{/if}">
	<table class="newArticleTable">
		...
		<tr>
			...
			<td><textarea class="articleTextInput" name="text">{$smarty.post.text}</textarea></td>
		</tr>
